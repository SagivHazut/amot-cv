...
export const PROJECT1_DATA = {
  ...
  // Used in SECTION 6 & 8: Process images and book spreads
  processImages: [PROJECT1_IMAGES.process1, PROJECT1_IMAGES.process2, PROJECT1_IMAGES.process3],
  // Used in SECTION 3 & 12: Gallery sections
  galleryImages: [PROJECT1_IMAGES.gallery1, PROJECT1_IMAGES.gallery2, PROJECT1_IMAGES.gallery3, PROJECT1_IMAGES.gallery4, PROJECT1_IMAGES.gallery5, PROJECT1_IMAGES.gallery6],
    ...
    values: [
      {
        ...
        description: "A safe space for testing ideas and taking creative risks."
      },
      {
        title: "Collaboration", 
      ...
      {
        title: "Accessibility",
        description: "Translating complex knowledge into public-facing experiences."
      }
    ]
  },
